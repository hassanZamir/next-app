...
import { FEED, IFeed, USER_SESSION } from '@Interfaces';
...
export const ReportFeedModal: React.ForwardRefRenderFunction<HTMLDivElement, IReportFeedModal.IProps> = ((props) => {
    ...
    async function handleSubmit(data: any) {
        setLoading(true);
        const params: IFeed.Actions.IGetReportFeedPayload = {
            contentId: feed.id,
