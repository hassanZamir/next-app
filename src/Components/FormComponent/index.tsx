...
export const FormComponent: React.FunctionComponent<IFormComponent.IProps> 
  = ({ submitSuccess, submitActive, defaultValues, children, onSubmit, triggerValidation }) => {
      ...
      return children.map(child => {
        if (child && child.props && child.props.name) {
          if (child.props.name === "reTypePassword") {
            child.props.validationRules.validate = (value: string) => { 
              return password.current ? value === password.current || "Password must match" : true 
            }
          }
